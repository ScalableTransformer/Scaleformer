\hypertarget{scaleformer-scalable-transformer-with-linear-complexity-and-relative-positional-encoding}{%
...
In the present work, by assembling together and building over ideas
